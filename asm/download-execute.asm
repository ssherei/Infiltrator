...
server_host:
	...
	db "UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU",0x00

get_server_uri:

	call httpopenrequest

	db "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",0x00

get_filename:

	call create_file

	db "OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO",0x00
